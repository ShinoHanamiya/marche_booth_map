(() => {
  ...
  window.APP_CONFIG = {
    ...
    favoriteStoragePrefix: "marche_booth_map_v1_10_favorites_",
    visitedStoragePrefix: "marche_booth_map_v1_10_visited_",
    legacyFavoriteStoragePrefixes: ["marche_booth_map_v1_9_favorites_", "marche_booth_map_v1_8_favorites_"],
    legacyVisitedStoragePrefixes: ["marche_booth_map_v1_9_visited_", "marche_booth_map_v1_8_visited_"],
    ...
    editorDraftKey: `marche_booth_map_v1_10_editor_draft_${editorEventId}`
  };
})();
