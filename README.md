# Marche Booth Map v1.7.1

1つのマルシェ会場内の出店者を、SVG会場マップと一覧から探せる静的Webアプリです。GitHub Pagesなどの静的ホスティングへそのまま公開できます。

## 重要事項・免責表示
- 本アプリは有志が作成した非商用アプリです。
- 掲載しているお店情報・リンク等には、誤りや変更が含まれる場合があります。
- 最新・正確な情報は、各出店者およびイベント主催者の公式情報をご確認ください。

## v1.7.1 変更内容
- View画面へ「有志制作・非商用アプリ」である旨を追加。
- View画面へ「お店情報・リンク等に誤りや変更が含まれる場合がある」旨を追加。
- 閲覧者マニュアル、編集者マニュアル、READMEへ同内容を追加。
...
## 変更履歴
- v1.7.1: View・マニュアル・READMEに、有志制作・非商用であること、および掲載情報・リンクに誤りや変更が含まれる可能性がある旨を追加。
